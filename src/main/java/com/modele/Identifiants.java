...
@NamedQueries({
    @NamedQuery(name = "recupererLesIdentifiants", query = "SELECT u FROM Identifiants u")})
public class Identifiants implements Serializable {
    ...
    public Identifiants(Integer id, String login, String mdp) {
        this.id = id;
        this.login = login;
        this.mdp = mdp;
    }
    ...
    public String toString() {
        return "com.controleur.Identifiant[ id=" + id + " ]";
    }
